...
namespace AzureFunctionNewDotnet
{
    ...
    public static class FunctionUsingEF
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)] HttpRequest req, ILogger log, ClaimsPrincipal cp)
        {
            ...
            var connectionString = System.Environment.GetEnvironmentVariable("AzureDBModelEntities");
            string accessToken = await getAADToken("https://database.windows.net/");
        ...
        private static async Task<GraphServiceClient> GetGraphApiClient(ILogger log)
        {
        ...
        private static void InsertUser(SqlConnection conn, string groupId, string groupDisplayName, string id, string memberType, string userName, string principalName)
        {
            ...
            string query = "INSERT INTO [STAGE].[AAD_USER]([AAD_GROUP_ID],[GROUP_DISPLAY_NAME],[ID],[MEMBER_TYPE],[USER_DISPLAY_NAME],[USER_PRINCIPAL_NAME],[CREATION_ID],[CREATION_DATETIME],[LAST_MODIFIED_ID],[LAST_MODIFIED_DATETIME])" +
        ...
        private static void InsertAADGroup(SqlConnection conn, string Id, string groupDisplayName)
        {
            ...
            // define INSERT query with parameters
            string query = "INSERT INTO [STAGE].[AAD_GROUP]([ID],[GROUP_DISPLAY_NAME],[CREATION_ID],[CREATION_DATETIME],[LAST_MODIFIED_ID],[LAST_MODIFIED_DATETIME])" +
